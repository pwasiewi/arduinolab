...
Thus, I get the [M5Stich-C](https://www.hackster.io/m5stack) that is [an amazing device based on ESP32 with a small LCD display of 80 × 160 pixel](https://www.hackster.io/m5stack), but bright and clear. 
