/*
    ...
    https://github.com/WiringProject/Wiring/blob/master/framework/libraries/MenuBackend/MenuBackend.h
...
const int buttonPinEsc = 1;     // pin for the Esc button
const int buttonPinEnter = 0;   // pin for the Enter button
